export class AppConstants {
  private static apiBaseUrl = 'https://localhost:7289/api/';
  ...
  static accountRecoveryUrls = {
    setRecovery: this.apiBaseUrl + 'accounts/recovery/setRecovery',
    getSecurityQuestion:
      this.apiBaseUrl + 'accounts/recovery/getSecurityQuestion',
    startRecovery: this.apiBaseUrl + 'accounts/recovery/startRecovery',
    getRecoveryUser: this.apiBaseUrl + 'accounts/recovery/getUser',
    resetPassword: this.apiBaseUrl + 'accounts/recovery/resetPassword',
  };
