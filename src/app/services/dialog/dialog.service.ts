...
export class DialogService {
  ...
  openViewRecordDialog(dialogData: ViewRecordDialogData) {
  ...
  openManageRecordDialog(dialogData: ManageRecordDialogData) {
  ...
  openShareRecordDialog(dialogData: ShareRecordDialogData) {
