...
import { ManageRecordDialogData } from '../../../models/dialog-data.model';
...
export class ManageRecordComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public dialogData: ManageRecordDialogData
  ) { }
  ...
  initializeForm() {
    ...
    this.manageRecordForm.controls.note.setValue(this.dialogData.record.note);
    ...
    this.manageRecordForm.controls.password.setValue(this.dialogData.record.password);
    this.manageRecordForm.controls.websiteUrl.setValue(this.dialogData.record.websiteUrl);
  }

  generatePassword() {
    this.manageRecordForm.controls.password.setValue(this.passwordService.generatePassword());
  }
